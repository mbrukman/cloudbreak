...
public class RegistratorBootstrap {
    ...
    public RegistratorBootstrap(DockerClient docker, String longName, String privateIp) {
        this.docker = docker;
    ...
    public Boolean call() throws Exception {
        ...
        CreateContainerResponse response = docker.createContainerCmd(REGISTRATOR.getContainer().get())

...
public class ConsulWatchBootstrap implements Callable<Boolean> {
    ...
    public ConsulWatchBootstrap(DockerClient docker, String longName, String privateIp, Long id) {
        this.docker = docker;
    ...
    public Boolean call() throws Exception {
        ...
        try {
            CreateContainerResponse response = docker.createContainerCmd(CONSUL_WATCH.getContainer().get())

...
public class ClusterSetupRunner {
    ...
    public void setupNewNode(ClusterScalingContext clusterScalingContext) throws CloudbreakException {
        ...
        clusterSetupService.preSetupNewNode(clusterScalingContext.getStackId(), gateway, clusterScalingContext.getCandidates());
        clusterSetupService.gatewaySetup(clusterScalingContext.getStackId(), gateway);
    }

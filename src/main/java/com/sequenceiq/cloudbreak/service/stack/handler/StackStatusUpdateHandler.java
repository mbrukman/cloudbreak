...
public class StackStatusUpdateHandler implements Consumer<Event<StackStatusUpdateRequest>> {
    ...
    public void accept(Event<StackStatusUpdateRequest> event) {
        ...
        if (StatusRequest.STOPPED.equals(statusRequest)) {
            ...
            pluginManager.triggerConsulEvent(stack.getId(), stack.getAllInstanceMetaData(), ConsulPluginEvent.STOP_AMBARI_EVENT);
            boolean stopped;
            ...
            if (started) {
                ...
                if (isSuccess(pollingResult)) {
                    ...
                    pluginManager.triggerConsulEvent(stack.getId(), updatedStack.getAllInstanceMetaData(), ConsulPluginEvent.START_AMBARI_EVENT);
    ...
    private PollingResult restartAmbariAgentsIfNeeded(Stack stack, PollingResult started) {
        if (!isSuccess(started)) {
            ...
            pluginManager.triggerConsulEvent(stack.getId(), stack.getAllInstanceMetaData(), ConsulPluginEvent.RESTART_AMBARI_EVENT);

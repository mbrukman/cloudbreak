...
public class AmbariRoleAllocator {
    ...
    public ClusterScalingContext updateNewInstanceMetadata(Long stackId, HostGroupAdjustmentJson hostGroupAdjustment, ScalingType scalingType) {
        ClusterScalingContext clusterScalingContext = null;
        ...
        if (PollingResult.SUCCESS.equals(waitForHosts(stack, ambariClient))) {
            ...
            List<HostMetadata> hostMetadata = addHostMetadata(cluster, hosts, hostGroupAdjustment);
            clusterScalingContext = new ClusterScalingContext(stackId, stack.cloudPlatform(), hostGroupAdjustment, hostMetadata, scalingType);
        }
